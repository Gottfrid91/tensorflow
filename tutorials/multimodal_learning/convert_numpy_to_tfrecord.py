        ...
        example = tf.train.Example(
            features=tf.train.Features(
                feature={
                    ...
                    'age': _int64_feature(int(age[index]))
...
def main(unused_argv):
  ...
  # read in data
  read_input = scipy.io.loadmat('/home/olle/PycharmProjects/multimodal_learning/data/train/train_32x32.mat')
  ...
  data_set.age = age.astype('uint8')

  # Convert to Examples and write the result to TFRecords.
  convert_to(data_set, 'train')
